...
local MODULE_URL = "https://raw.githubusercontent.com/checkurasshole/combowick-loader/main/combowick_module_g2.lua"
local repo       = "https://raw.githubusercontent.com/deividcomsono/Obsidian/main/"

local M
do
    -- Cache-buster: many executors cache game:HttpGet per-URL for the session, which
    -- pins an OLD module until the user rejoins. A unique query param forces a fresh
    -- fetch every run so module updates take effect without rejoining.
    local ok, m = pcall(function() return loadstring(game:HttpGet(MODULE_URL .. "?cb=" .. tostring(tick())))() end)
